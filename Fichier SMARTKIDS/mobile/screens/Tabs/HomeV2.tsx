...
import { Box, FlatList, HStack, ScrollView, SelectContent, SelectDragIndicator, SelectIcon, SelectInput, SelectItem, SelectPortal, Slider, SliderFilledTrack, View, VStack } from '@gluestack-ui/themed';
...
export default function HomeScreen({
    navigation,
    //@ts-ignore
}: StackScreenProps<StackTabParamList, 'home-v2'>) {
                        ...
                        >
                            ...
                            <HStack px={16} justifyContent='space-between' flexWrap='wrap'>
                                ...
                                <FlatList
                                    ...
                                    ListFooterComponent={
                                        isFetching ? (
                                            <VStack justifyContent="center" alignItems='center' width="100%" mt={32}>
                                                <ActivityIndicator size="small" color={Colors.light.primary} />
                                            </VStack>
                                        ) : null
                                    }
