...
import { formatIsoTimeToStr, timeLabelToIsoTimeStr, timeLabelToTimeStr } from '../../src/utils/date';
...
const EditStep3 = (props: componentNameProps) => {
    ...
    const opening_hours_array = createEtablissement ? createEtablissement.dailyOpeningHours.map((day, key) => ({
        day: key,
        from: formatIsoTimeToStr(day.from),
        to: formatIsoTimeToStr(day.to),
    ...
    const INITIAL_OPENING_HOURS: CurrentOpeningHours = opening_hours_array
        .reduce((acc, curr) => {
                                    ...
                                    >
                                        <HStack space='md' w={"85%"}>
                                            ...
                                            <VStack flex={4} gap={4}>
                                                ...
                                                />
                                                <StyledText size={10}>Ex: 10 €</StyledText>
                                            </VStack>
                                        </HStack>
                                        <Pressable
                                            w="10%"
