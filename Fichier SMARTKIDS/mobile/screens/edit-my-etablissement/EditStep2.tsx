...
const EditStep2 = (props: componentNameProps) => {
    ...
    const {
        ...
        defaultValues: {
            nom: createEtablissement?.nom,
            description: createEtablissement?.description,
            code_promo: createEtablissement?.code_promo,
            phone: createEtablissement?.phone
        }
    });
    ...
    useEffect(() => {
        if (editEtablissement?.min_age && editEtablissement.max_age) {
            dispatch(setCreateEtablissement({ min_age: editEtablissement?.min_age, max_age: editEtablissement?.max_age }));
            setValues([editEtablissement?.min_age, editEtablissement?.max_age])
        }
    }, [editEtablissement])

    const EtablissementForm = useMemo(() => () => {
        return (
