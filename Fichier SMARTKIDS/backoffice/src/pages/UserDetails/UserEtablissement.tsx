...
import { useGetEtablissementByUserQuery } from "@/redux/etablissement/etblissement.apiSlice";
import CarouselSlider from "@/components/CarouselSlider";
import { MapPin, Phone, Wifi } from "lucide-react";

export default function UserEtablissement({ userId }: { userId: string }) {
  const { data, isFetching } = useGetEtablissementByUserQuery(userId);
